...
public interface OrderApi {
    ...
    @GetMapping("{id}")
    ResponseEntity<OrderResponseDTO> findOrderById(@PathVariable UUID id);
    ...
    @PutMapping("{id}")
    ResponseEntity<OrderResponseDTO> updateOrder(@PathVariable UUID id, @RequestBody OrderUpdateDTO dto);
