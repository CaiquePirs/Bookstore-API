...
public interface ClientApi {
    ...
    @PostMapping
    ResponseEntity<ClientResponseDTO> createClient(@RequestBody @Valid ClientRequestDTO dto);
    ...
    @GetMapping("{id}")
    ResponseEntity<ClientResponseDTO> findClientById(@PathVariable UUID id);
    ...
    @GetMapping
    ResponseEntity<Page<ClientResponseDTO>> listClientsByFilter(
    ...
    @PutMapping("{id}")
    ResponseEntity<ClientResponseDTO> updateClient(@PathVariable UUID id, @RequestBody @Valid ClientUpdateDTO dto);
}
