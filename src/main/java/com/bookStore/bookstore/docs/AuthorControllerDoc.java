...
public interface AuthorControllerDoc {
    ...
    @PostMapping
    ResponseEntity<AuthorResponseDTO> create(@RequestBody @Valid AuthorDTO dto);
    ...
    @GetMapping("{id}")
    ResponseEntity<AuthorResponseDTO> searchAuthor(@PathVariable UUID id);
    ...
    @PutMapping("{id}")
    ResponseEntity<AuthorResponseDTO> update(@PathVariable UUID id, @RequestBody @Valid AuthorDTO dto);
}
